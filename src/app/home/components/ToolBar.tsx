                ...
                >
                    <div style={{margin: 20, borderRadius: 1000}}>
                        ...
                        <div style={{
                            ...
                            <span style={{margin: 10, cursor: "pointer"}} onClick={logout}>로그아웃</span>
                            <Link href={"/changePW"}><span style={{margin: 10, cursor: "pointer"}}>비밀번호 변경</span></Link>
                            <Link href={"/cookie"}><span style={{margin: 10, cursor: "pointer"}}>쿠키 구매</span></Link>
                        </div>
                        {userName ? (
                            <span
